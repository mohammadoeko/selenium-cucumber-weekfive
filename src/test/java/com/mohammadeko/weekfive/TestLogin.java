package com.mohammadeko.weekfive;

import com.mohammadeko.weekfive.pages.Login;
...
public class TestLogin {
    ...
    public void user_enter_username_or_email_password_invalid() {
        login.loginPage();
        login.loginForm("mohammadeko2000@email.com", "Rumahku123");
    ...
    public void user_valid_credentials() {
        Assert.assertEquals(login.getTxtMyAccount(), "mohammadeko2000");
